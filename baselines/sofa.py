...
def getSOFA(db, hadm_id):
    ...
    for _, icu in icus.iterrows():
        ...
        query = "SELECT c.sofa FROM sofa c WHERE c.icustay_id=" + str(icustay_id) + ";"
        rows = db.query(query)
...
if __name__== "__main__":
    ...
    result_df.to_csv("../data/results/sofa_results.csv", index=None)
